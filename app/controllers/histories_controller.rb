class HistoriesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to histories_path, status: :see_other, notice: "History was successfully destroyed." }
  ...
  private
    ...
    def history_params
      params.require(:history).permit(:project_id, :user_id, :previous_status, :new_status)
    end
end
